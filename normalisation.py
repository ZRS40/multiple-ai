...
def main():
    ...
    if os.path.exists(MODEL_PATH):
        ...
        if choix == 't':
            ...
            train_model(model, entree_norm, sortie_norm, epochs=3000)
        ...
        train_model(model, entree_norm, sortie_norm, epochs=1000)
    ...
    try:
        while True:
            ...
            x_norm = x / max_entree
            pred_norm = model.predict(np.array([[x_norm]], dtype=dtype), verbose=0)[0][0]
            pred = pred_norm * max_sortie
